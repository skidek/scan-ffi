...
public class _MEMORY_BASIC_INFORMATION {
    ...
    public static MemoryAddress BaseAddress$get(MemorySegment seg) {
        return (MemoryAddress)_MEMORY_BASIC_INFORMATION.BaseAddress$VH.get(seg);
    }
    ...
    public static MemoryAddress BaseAddress$get(MemorySegment seg, long index) {
        return (MemoryAddress)_MEMORY_BASIC_INFORMATION.BaseAddress$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress AllocationBase$get(MemorySegment seg) {
        return (MemoryAddress)_MEMORY_BASIC_INFORMATION.AllocationBase$VH.get(seg);
    }
    ...
    public static MemoryAddress AllocationBase$get(MemorySegment seg, long index) {
        return (MemoryAddress)_MEMORY_BASIC_INFORMATION.AllocationBase$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle PartitionId$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("PartitionId"));
